...
function Signup() {
  ...
  return (
    <div className="min-h-dvh grid grid-cols-12 items-center justify-center bg-emerald-50 px-4 py-4">
      <div className=" min-h-dvh col-span-12 sm:col-span-6 px-4 py-6 flex flex-col justify-center">
        <div className="sm:max-w-sm mx-auto w-full">
          ...
          <button
            ...
            className="sm:hidden w-full mt-8 py-4 flex items-center justify-center gap-5 rounded-md bg-emerald-500 text-white font-semibold hover:bg-emerald-600 transition-colors duration-300"
          >
            🚀 Try LAN Feature
          </button>
