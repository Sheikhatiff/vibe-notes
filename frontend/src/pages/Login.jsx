...
function Login() {
  ...
  return (
    <div className="min-h-dvh grid grid-cols-12 items-center justify-center bg-emerald-50 px-4 py-4">
      ...
      <div className=" min-h-dvh col-span-12 sm:col-span-6 px-6 py-8 flex flex-col justify-center">
        <div className="sm:max-w-sm mx-auto w-full">
          <div className=" uppercase tracking-wide  ">
            <h1 className="font-bold text-2xl">Welcome Back</h1>
            <h5 className="text-stone-500 mt-4">Sign in to your account</h5>
          </div>

          {/* Mobile: Try LAN feature button */}
          <button
            type="button"
            onClick={handleLANClick}
            className="sm:hidden w-full mt-12 py-4 flex items-center justify-center gap-5 rounded-md bg-emerald-500 text-white font-semibold hover:bg-emerald-600 transition-colors duration-300"
          >
            🚀 Try LAN Feature
          </button>
